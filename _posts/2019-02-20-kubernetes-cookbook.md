...
- [Comment ...](#comment)
	...
	- [Update l'application (Rolling Update)](#update-lapplication-rolling-update)
		- [Spécifier une nouvelle image au niveau du Deployment](#sp%C3%A9cifier-une-nouvelle-image-au-niveau-du-deployment)
		- [Vérifier le statut du rollout](#v%C3%A9rifier-le-statut-du-rollout)
		- [Rollback un déploimeent à la version précédente de l'image](#rollback-un-d%C3%A9ploimeent-%C3%A0-la-version-pr%C3%A9c%C3%A9dente-de-limage)
	- [Gérer les secrets](#g%C3%A9rer-les-secrets)
	...
	- [Contextes](#contextes)
		- [Afficher le contexte courant](#afficher-le-contexte-courant)
		- [Lister les contextes disponibles](#lister-les-contextes-disponibles)
		- [Changer de contexte](#changer-de-contexte)
		- [Supprimer un contexte](#supprimer-un-contexte)
	- [Divers](#divers)
		- [Configurer le daemon Docker pour qu'il utiliser le host de Minikube](#configurer-le-daemon-docker-pour-quil-utiliser-le-host-de-minikube)
		- [Configurer le daemon Docker pour qu'il utilise le host par défaut](#configurer-le-daemon-docker-pour-quil-utilise-le-host-par-d%C3%A9faut)
